...
if ( function_exists( 'register_block_style' ) ) {
    register_block_style(
        'core/post-date',
        array(
            'name'         => 'dentix-post-date-icon',
            'label'        => __( 'Post Date Icon', 'dentix' ),
            'is_default'   => true,
    ...
    register_block_style(
        ...
        array(
            'name'         => 'dentix-post-author-name-icon',
            'label'        => __( 'Post Aurhor Name Icon', 'dentix' ),
            'is_default'   => true,
    ...
    register_block_style(
        ...
        array(
            'name'         => 'dentix-post-featured-image',
            'label'        => __( 'Post Featured Image', 'dentix' ),
            'is_default'   => true,
    ...
    register_block_style(
        'core/post-title',
        array(
            'name'         => 'dentix-post-title',
            'label'        => __( 'Post Title', 'dentix' ),
            'is_default'   => true,
    ...
    register_block_style(
        'core/post-excerpt',
        array(
            'name'         => 'dentix-post-excerpt',
            'label'        => __( 'Post Excerpt', 'dentix' ),
            'is_default'   => true,
    ...
    register_block_style(
        'core/post-comments',
        array(
            'name'         => 'dentix-post-comments',
            'label'        => __( 'Post Comments', 'dentix' ),
            'is_default'   => true,
