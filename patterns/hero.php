    ...
    <div class="wp-block-cover__inner-container"><!-- wp:group {"className":"bannerInfo","style":{"spacing":{"padding":{"top":"0","right":"0","bottom":"0","left":"0"},"blockGap":"0","margin":{"top":"0","bottom":"0"}}},"layout":{"type":"constrained","contentSize":"600px","justifyContent":"left"}} -->
        <div class="wp-block-group bannerInfo" style="margin-top:0;margin-bottom:0;padding-top:0;padding-right:0;padding-bottom:0;padding-left:0">
            ...
            <div class="wp-block-buttons"><!-- wp:button {"textAlign":"center","backgroundColor":"accent-color","textColor":"foreground","className":"is-style-fill","style":{"typography":{"fontSize":"26px","textTransform":"uppercase"}}} -->
                <div class="wp-block-button has-custom-font-size is-style-fill" style="font-size:26px;text-transform:uppercase"><a href="#" class="wp-block-button__link has-foreground-color has-accent-color-background-color has-text-color has-background has-text-align-center wp-element-button">
                        <?php echo esc_html__('Enquire now', 'pedicare-child-health-clinic'); ?> <img class="wp-image-22" style="height: 22px;" src="<?php echo esc_url(get_template_directory_uri());?>/src/images/icons/arrow-right.svg" alt="arrow right">
                    </a></div>
                <!-- /wp:button --></div>
            <!-- /wp:buttons --></div>
        <!-- /wp:group --></div></div>
