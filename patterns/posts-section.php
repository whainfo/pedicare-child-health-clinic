...
<div class="wp-block-group" id="offshoot" style="padding-top:var(--wp--preset--spacing--80);padding-right:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--80);padding-left:var(--wp--preset--spacing--50)"><!-- wp:columns {"style":{"spacing":{"margin":{"bottom":"40px"},"padding":{"top":"0","bottom":"0"}}}} -->
    <div class="wp-block-columns" style="margin-bottom:40px;padding-top:0;padding-bottom:0"><!-- wp:column -->
        <div class="wp-block-column"><!-- wp:group {"style":{"spacing":{"blockGap":"0","margin":{"top":"0","bottom":"var:preset|spacing|80"}}},"layout":{"type":"constrained","contentSize":"656px"}} -->
            ...
            <div class="wp-block-query">
                ...
                <!-- wp:read-more {"content":"Read more >","style":{"elements":{"link":{"color":{"text":"var:preset|color|accent-color"}}}},"textColor":"accent-color"} /-->
                <!-- /wp:post-template -->
            </div>
            <!-- /wp:query -->
