 ...
 * Slug: dentix/single-doctor-content
    ...
    <div class="wp-block-columns"><!-- wp:column {"width":"40%","style":{"spacing":{"padding":{"top":"0","bottom":"0"}}}} -->
        <div class="wp-block-column" style="padding-top:0;padding-bottom:0;flex-basis:40%"><!-- wp:group {"style":{"spacing":{"padding":{"top":"var:preset|spacing|70","bottom":"var:preset|spacing|70"}},"color":{"background":"#d1f0f1"},"border":{"radius":"53px"}},"layout":{"type":"constrained"}} -->
            <div class="wp-block-group has-background" style="border-radius:53px;background-color:#d1f0f1;padding-top:var(--wp--preset--spacing--70);padding-bottom:var(--wp--preset--spacing--70)">
                ...
                <!-- wp:image {"id":80,"sizeSlug":"full","linkDestination":"none","align":"center","className":"dentix-doctor"} -->
                <figure class="wp-block-image aligncenter size-full dentix-doctor">
                ...
                <h4 class="wp-block-heading has-text-align-center" style="margin-top:var(--wp--preset--spacing--60)"><strong><?php echo esc_html__('clinical interests', 'dentix'); ?></strong></h4>
                <!-- /wp:heading -->

                <!-- wp:list {"ordered":true,"className":"dentix-list"} -->
                <ol class="wp-block-list dentix-list"><!-- wp:list-item -->
        ...
        <div class="wp-block-column" style="flex-basis:60%">
            ...
            <h2 class="wp-block-heading has-title-highlight-color has-text-color has-link-color has-xxl-font-size" style="font-style:normal;font-weight:600;text-transform:none"><?php echo esc_html__('Dr Jeremy Rajanayagam', 'dentix'); ?></h2>
            <!-- /wp:heading -->
            ...
            <!-- wp:paragraph -->
            <p><?php echo esc_html__('He is able to provide flexible new and review appointments with short wait times. He is also happy to be discuss patient referrals. When Jeremy is not working he enjoys being a father to two young children and chasing his kids at the park.', 'dentix'); ?></p>
            <!-- /wp:paragraph --></div>
        <!-- /wp:column -->
    </div>
    <!-- /wp:columns --></div>
