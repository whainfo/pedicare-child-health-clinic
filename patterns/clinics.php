 ...
 */
?>
<!-- wp:group {"tagName":"main","className":"main-frontpage dentix-clinics","style":{"spacing":{"padding":{"top":"var:preset|spacing|80","bottom":"var:preset|spacing|80","right":"var:preset|spacing|50","left":"var:preset|spacing|50"}}},"layout":{"type":"constrained","contentSize":"1360px"}} -->
<main class="wp-block-group main-frontpage dentix-clinics"
    ...
    <div class="wp-block-group alignfull has-foreground-background-color has-background" id="section-1"
        ...
        <div class="wp-block-group" style="margin-bottom:var(--wp--preset--spacing--50)">
            ...
            <h2 class="wp-block-heading has-text-align-center" style="margin-bottom:var(--wp--preset--spacing--70);text-transform:none">
                <?php echo esc_html__('Our', 'dentix'); ?> <mark style="background-color:rgba(0, 0, 0, 0)" class="has-inline-color has-title-highlight-color"><?php echo esc_html__('Team', 'dentix'); ?></mark></h2>
            <!-- /wp:heading -->
        </div>
        <!-- /wp:group -->
        ...
        <div class="wp-block-group" style="padding-top:0;padding-bottom:0">
            ...
            <div class="wp-block-group"><!-- wp:image {"lightbox":{"enabled":false},"id":30,"sizeSlug":"full","linkDestination":"custom","align":"center"} -->
                ...
                <p class="has-text-align-center has-m-font-size" style="line-height:1.5;text-transform:uppercase"><a href="#"><?php echo esc_html__('COELIAC DISEASE', 'dentix'); ?></a></p>
                <!-- /wp:paragraph --></div>
            <!-- /wp:group -->
            <!-- wp:group {"layout":{"type":"constrained"}} -->
            <div class="wp-block-group"><!-- wp:image {"lightbox":{"enabled":false},"id":30,"sizeSlug":"full","linkDestination":"custom","align":"center"} -->
                ...
                <!-- wp:paragraph {"align":"center","style":{"typography":{"textTransform":"uppercase","lineHeight":"1.5"}},"fontSize":"m"} -->
                <p class="has-text-align-center has-m-font-size" style="line-height:1.5;text-transform:uppercase"><a href="#"><?php echo esc_html__('CHILD BEHAVIOUR', 'dentix'); ?></a></p>
                <!-- /wp:paragraph --></div>
            <!-- /wp:group -->
            <!-- wp:group {"layout":{"type":"constrained"}} -->
            <div class="wp-block-group"><!-- wp:image {"lightbox":{"enabled":false},"id":30,"sizeSlug":"full","linkDestination":"custom","align":"center"} -->
            ...
            <div class="wp-block-group"><!-- wp:image {"lightbox":{"enabled":false},"id":30,"sizeSlug":"full","linkDestination":"custom","align":"center"} -->
                ...
                <!-- wp:paragraph {"align":"center","style":{"typography":{"textTransform":"uppercase","lineHeight":"1.5"}},"fontSize":"m"} -->
                <p class="has-text-align-center has-m-font-size" style="line-height:1.5;text-transform:uppercase"><a href="#"><?php echo esc_html__('AUTISM ASSESSMENTS', 'dentix'); ?></a></p>
                <!-- /wp:paragraph --></div>
            <!-- /wp:group -->
            <!-- wp:group {"layout":{"type":"constrained"}} -->
            <div class="wp-block-group"><!-- wp:image {"lightbox":{"enabled":false},"id":30,"sizeSlug":"full","linkDestination":"custom","align":"center"} -->
                ...
                <!-- wp:paragraph {"align":"center","style":{"typography":{"textTransform":"uppercase","lineHeight":"1.5"}},"fontSize":"m"} -->
                <p class="has-text-align-center has-m-font-size" style="line-height:1.5;text-transform:uppercase"><a href="#"><?php echo esc_html__('TRAVEL IMMUNISATIONS', 'dentix'); ?></a></p>
                <!-- /wp:paragraph --></div>
            <!-- /wp:group -->
            <!-- wp:group {"layout":{"type":"constrained"}} -->
            <div class="wp-block-group"><!-- wp:image {"lightbox":{"enabled":false},"id":30,"sizeSlug":"full","linkDestination":"custom","align":"center"} -->
                ...
                <!-- wp:paragraph {"align":"center","style":{"typography":{"textTransform":"uppercase","lineHeight":"1.5"}},"fontSize":"m"} -->
                <p class="has-text-align-center has-m-font-size" style="line-height:1.5;text-transform:uppercase"><a href="#"><?php echo esc_html__('FUSSY FEEDERS', 'dentix'); ?></a></p>
                <!-- /wp:paragraph --></div>
            <!-- /wp:group -->
            <!-- wp:group {"layout":{"type":"constrained"}} -->
            <div class="wp-block-group"><!-- wp:image {"lightbox":{"enabled":false},"id":30,"sizeSlug":"full","linkDestination":"custom","align":"center"} -->
                ...
                <!-- wp:paragraph {"align":"center","style":{"typography":{"textTransform":"uppercase","lineHeight":"1.5"}},"fontSize":"m"} -->
                <p class="has-text-align-center has-m-font-size" style="line-height:1.5;text-transform:uppercase"><a href="#"><?php echo esc_html__('UNSETTLED BABY', 'dentix'); ?></a></p>
                <!-- /wp:paragraph --></div>
            <!-- /wp:group -->
            <!-- wp:group {"layout":{"type":"constrained"}} -->
            <div class="wp-block-group"><!-- wp:image {"lightbox":{"enabled":false},"id":30,"sizeSlug":"full","linkDestination":"custom","align":"center"} -->
                ...
                <!-- wp:paragraph {"align":"center","style":{"typography":{"textTransform":"uppercase","lineHeight":"1.5"}},"fontSize":"m"} -->
                <p class="has-text-align-center has-m-font-size" style="line-height:1.5;text-transform:uppercase"><a href="#"><?php echo esc_html__('CONTINENCE CLINIC', 'dentix'); ?></a></p>
                <!-- /wp:paragraph --></div>
            <!-- /wp:group -->
            <!-- wp:group {"layout":{"type":"constrained"}} -->
            <div class="wp-block-group"><!-- wp:image {"lightbox":{"enabled":false},"id":30,"sizeSlug":"full","linkDestination":"custom","align":"center"} -->
                ...
                <!-- wp:paragraph {"align":"center","style":{"typography":{"textTransform":"uppercase","lineHeight":"1.5"}},"fontSize":"m"} -->
                <p class="has-text-align-center has-m-font-size" style="line-height:1.5;text-transform:uppercase"><a href="#"><?php echo esc_html__('LIVER CLINIC', 'dentix'); ?></a></p>
                <!-- /wp:paragraph --></div>
            <!-- /wp:group -->
            <!-- wp:group {"layout":{"type":"constrained"}} -->
            <div class="wp-block-group"><!-- wp:image {"lightbox":{"enabled":false},"id":30,"sizeSlug":"full","linkDestination":"custom","align":"center"} -->
                ...
                <!-- wp:paragraph {"align":"center","style":{"typography":{"textTransform":"uppercase","lineHeight":"1.5"}},"fontSize":"m"} -->
                <p class="has-text-align-center has-m-font-size" style="line-height:1.5;text-transform:uppercase"><a href="#"><?php echo esc_html__('SLEEP', 'dentix'); ?></a></p>
                <!-- /wp:paragraph --></div>
            <!-- /wp:group -->
            <!-- wp:group {"layout":{"type":"constrained"}} -->
            <div class="wp-block-group"><!-- wp:image {"lightbox":{"enabled":false},"id":30,"sizeSlug":"full","linkDestination":"custom","align":"center"} -->
                ...
                <!-- wp:paragraph {"align":"center","style":{"typography":{"textTransform":"uppercase","lineHeight":"1.5"}},"fontSize":"m"} -->
                <p class="has-text-align-center has-m-font-size" style="line-height:1.5;text-transform:uppercase"><a href="#"><?php echo esc_html__('SPEECH & LANGUAGE', 'dentix'); ?></a></p>
                <!-- /wp:paragraph --></div>
            <!-- /wp:group -->
            <!-- wp:group {"layout":{"type":"constrained"}} -->
            <div class="wp-block-group"><!-- wp:image {"lightbox":{"enabled":false},"id":30,"sizeSlug":"full","linkDestination":"custom","align":"center"} -->
                ...
                <!-- wp:paragraph {"align":"center","style":{"typography":{"textTransform":"uppercase","lineHeight":"1.5"}},"fontSize":"m"} -->
                <p class="has-text-align-center has-m-font-size" style="line-height:1.5;text-transform:uppercase"><a href="#"><?php echo esc_html__('Child Obesity', 'dentix'); ?></a></p>
                <!-- /wp:paragraph --></div>
            <!-- /wp:group -->
        </div>
        <!-- /wp:group -->
