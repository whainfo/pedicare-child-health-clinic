...
<main class="wp-block-group main-frontpage PediCare-Child-Health-Clinic-services" id="services"
    ...
    <div class="wp-block-group alignfull has-foreground-background-color has-background"
        ...
        <div class="wp-block-group" style="margin-bottom:var(--wp--preset--spacing--50)">
            ...
            <h2 class="wp-block-heading has-text-align-center" style="text-transform:none">Services</h2>
            <!-- /wp:heading --></div>
        <!-- /wp:group -->
        ...
        <div class="wp-block-group" style="padding-top:0;padding-bottom:0">
            ...
            <div class="wp-block-group">
                <!-- wp:image {"id":30,"sizeSlug":"full","linkDestination":"none","align":"center"} -->
                <figure class="wp-block-image aligncenter size-full"><img
                            src="<?php echo esc_url(get_template_directory_uri()); ?>/src/images/icons/services/icon-24.png"
                            alt="" class="wp-image-30"/></figure>
                <!-- /wp:image -->
            ...
            <div class="wp-block-group">
                <!-- wp:image {"id":30,"sizeSlug":"full","linkDestination":"none","align":"center"} -->
                <figure class="wp-block-image aligncenter size-full"><img
                            src="<?php echo esc_url(get_template_directory_uri()); ?>/src/images/icons/services/icon-22.png"
                            alt="" class="wp-image-30"/></figure>
                <!-- /wp:image -->
