...
<div class="wp-block-group has-background" style="background-color:#fff8de;margin-top:var(--wp--preset--spacing--70);margin-bottom:var(--wp--preset--spacing--70);padding-top:var(--wp--preset--spacing--70);padding-bottom:var(--wp--preset--spacing--70)">
    ...
    <h2 class="wp-block-heading has-text-align-center" style="margin-top:0;margin-bottom:var(--wp--preset--spacing--70);text-transform:capitalize">Related&nbsp;<mark style="background-color:rgba(0, 0, 0, 0);color:#f08304" class="has-inline-color">Services</mark></h2>
    <!-- /wp:heading -->
