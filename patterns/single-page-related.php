 ...
 * Slug: PediCare-Child-Health-Clinic/single-page-related
...
<div class="wp-block-group has-background" style="background-color:#fff8de;margin-top:var(--wp--preset--spacing--70);margin-bottom:var(--wp--preset--spacing--70);padding-top:var(--wp--preset--spacing--70);padding-bottom:var(--wp--preset--spacing--70)"><!-- wp:heading {"textAlign":"center","style":{"typography":{"textTransform":"capitalize"},"spacing":{"margin":{"top":"0","bottom":"0"}}}} -->
    <h2 class="wp-block-heading has-text-align-center" style="margin-top:0;margin-bottom:0;text-transform:capitalize">Related <mark style="background-color:rgba(0, 0, 0, 0);color:#f08304" class="has-inline-color">Services</mark></h2>
    <!-- /wp:heading -->
