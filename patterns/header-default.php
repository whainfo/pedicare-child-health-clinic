 ...
 * Slug: dentix/header-default
 * Categories: dentix, featured, header
 * Viewport Width: 1360
 */
?>
<!-- wp:group {"className":"header","style":{"spacing":{"padding":{"top":"var:preset|spacing|40","right":"var:preset|spacing|20","bottom":"var:preset|spacing|40","left":"var:preset|spacing|20"}},"position":{"type":""}},"backgroundColor":"foreground","layout":{"type":"constrained","contentSize":"1360px","wideSize":"1360px"}} -->
    ...
    <div class="wp-block-group alignwide"><!-- wp:site-logo {"shouldSyncIcon":true} /-->
        ...
        <div class="wp-block-group mobile-hidden"><!-- wp:buttons {"fontSize":"m","layout":{"type":"flex","verticalAlignment":"center","justifyContent":"right"}} -->
            <div class="wp-block-buttons has-custom-font-size has-m-font-size"><!-- wp:button {"textColor":"background","className":"is-style-outline","style":{"elements":{"link":{"color":{"text":"var:preset|color|background"}}},"border":{"width":"0px","style":"none"}}} -->
                <div class="wp-block-button is-style-outline"><a class="wp-block-button__link has-background-color has-text-color has-link-color wp-element-button" style="border-style:none;border-width:0px"><img class="wp-image-16" style="width: 16px;" src="http://wp.offspring.loc/wp-content/themes/dentix/src/images/phone.svg" alt="">  1646464654646</a></div>
                <!-- /wp:button -->
        ...
        <!-- wp:navigation-link {"label":"<?php echo esc_html__('Home', 'dentix'); ?>","url":"#","kind":"custom","isTopLevelLink":true} /-->

        <!-- wp:navigation-link {"label":"<?php echo esc_html__('Services', 'dentix'); ?>","url":"#services","kind":"custom","isTopLevelLink":true} /-->

        <!-- wp:navigation-link {"label":"<?php echo esc_html__('Team', 'dentix'); ?>","url":"#team","kind":"custom","isTopLevelLink":true} /-->

        <!-- wp:navigation-link {"label":"<?php echo esc_html__('Offshoot', 'dentix'); ?>","url":"#offshoot","kind":"custom","isTopLevelLink":true} /-->

        <!-- wp:navigation-link {"label":"<?php echo esc_html__('Contact Us', 'dentix'); ?>","url":"#contact-us","kind":"custom","isTopLevelLink":true} /-->
        <!-- /wp:navigation -->
    </div>
    <!-- /wp:group -->
