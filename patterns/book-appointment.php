 ...
 * Slug: dentix/book-appointment
 * Categories: dentix, featured
 * Viewport Width: 1360
 */
?>
<!-- wp:group {"className":"main-frontpage dentix-book-appointment","style":{"spacing":{"padding":{"top":"var:preset|spacing|50","bottom":"var:preset|spacing|50"}}},"layout":{"type":"constrained","contentSize":"1360px"}} -->
<div class="wp-block-group main-frontpage dentix-book-appointment" style="padding-top:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--50)"><!-- wp:columns -->
            ...
            <div class="wp-block-buttons"><!-- wp:button {"textColor":"footer-bottom","style":{"typography":{"fontStyle":"normal","fontWeight":"700"},"elements":{"link":{"color":{"text":"var:preset|color|footer-bottom"}}}},"fontSize":"xl"} -->
                <div class="wp-block-button has-custom-font-size has-xl-font-size" style="font-style:normal;font-weight:700">
                    <a class="wp-block-button__link has-footer-bottom-color has-text-color has-link-color wp-element-button">
                        <strong><img class="wp-image-16" style="width: 33px;" src="<?php echo esc_url(get_template_directory_uri()); ?>/src/images/phone-green.svg" alt=""> <?php echo esc_html__('1646464654646', 'dentix'); ?></strong></a></div>
                <!-- /wp:button -->
                ...
                <div class="wp-block-button has-custom-font-size has-l-font-size" style="font-style:normal;font-weight:700">
                    <a class="wp-block-button__link has-foreground-color has-accent-color-background-color has-text-color has-background has-link-color has-text-align-center wp-element-button">
                        <strong><?php echo esc_html__('REQUEST ONLINE', 'dentix'); ?></strong>
                    </a></div>
                <!-- /wp:button --></div>
            <!-- /wp:buttons --></div>
        <!-- /wp:column -->
