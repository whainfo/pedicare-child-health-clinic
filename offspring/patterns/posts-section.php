    ...
    <div class="wp-block-columns" style="margin-bottom:40px"><!-- wp:column -->
        <div class="wp-block-column"><!-- wp:group {"style":{"spacing":{"blockGap":"0","margin":{"top":"0","bottom":"var:preset|spacing|80"}}},"layout":{"type":"constrained","contentSize":"656px"}} -->
            <div class="wp-block-group" style="margin-top:0;margin-bottom:var(--wp--preset--spacing--80)"><!-- wp:heading {"textAlign":"center","level":3,"style":{"spacing":{"margin":{"bottom":"var:preset|spacing|50"}}},"textColor":"blue-light","className":"has-subtitle-color","fontSize":"regular"} -->
                <h3 class="wp-block-heading has-text-align-center has-subtitle-color has-blue-light-color has-text-color has-regular-font-size" style="margin-bottom:var(--wp--preset--spacing--50)"><?php echo esc_html__('From Blog Post', 'offspring'); ?></h3>
                <!-- /wp:heading -->
                ...
                <h2 class="wp-block-heading has-text-align-center has-blue-dark-color has-text-color" style="margin-bottom:var(--wp--preset--spacing--50);font-size:42px"><?php echo esc_html__('News and Articles', 'offspring'); ?></h2>
                <!-- /wp:heading -->
                ...
                <p class="has-text-align-center" style="margin-bottom:var(--wp--preset--spacing--50);padding-top:0;padding-right:0;padding-bottom:0;padding-left:0"><?php echo esc_html__('Doloribus fames facilisis nullam? Nisi veniam anim quia, mauris eiusmod ullamco at morbi eius purus ac provident ante, habitant commodi, nihil dignissimos.', 'offspring'); ?></p>
                <!-- /wp:paragraph --></div>
            <!-- /wp:group -->
